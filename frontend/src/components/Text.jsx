...
function Text({ Text: label, Path:path }) {
  ...
  return (
    <div className='w-[300px]  py-8 px-4'>
     <div className='text-lg text-white py-4'> <a href="/" >Home {alph} </a> <a href={label}>{label}{alph}</a></div>
      <h1 className='text-4xl font-semibold leading-9 text-white'> {label.toUpperCase()}</h1>
